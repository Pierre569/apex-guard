...
import { handleVapiToGHL } from '@/lib/ghl-bridge';
        ...
        if (message.type === 'assistant-request') {
            ...
            return NextResponse.json({
                assistantOverrides: {
                    ...
                    firstMessage: `Hi ${firstName !== 'there' ? firstName : ''}, this is Alex from Apex Guard. How can I help you today?`,
                    model: {
                        provider: "google",
                        model: "gemini-1.5-flash", // Fast Anti-Freeze Model
                        ...
                        tools: [
                            {
                                ...
                                function: {
                                    ...
                                    description: "Checks if a date/time is available.",
                                    parameters: {
                                        type: "object",
                                        properties: {
                                            date: { type: "string", description: "YYYY-MM-DD" },
                                            time: { type: "string", description: "10am, 2pm" }
                                        }
                                    }
                                }
                            },
            ...
            for (const call of toolCalls) {
                ...
                if (call.type === 'function') {
                    ...
                    if (name === 'checkAvailability') {
                        results.push({
                            toolCallId: call.id,
                            result: "Yes, that time is open. Would you like to lock it in?"
                        });
                    }
